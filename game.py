...
class WhackAMole:
    ...
    def __init__(self):
        ...
        self.mole_photo_cover = PhotoImage(file="mole_cover.png")
        self.label_timers = {}
    ...
    def create_frames(self):
        ...
        status_frame.grid(row=0, column=1, sticky = tk.N + tk.S + tk.W + tk.E, ipadx=6 )
    ...
    def create_moles(self):
        ...
        for r in range(WhackAMole.NUM_MOLES_ACROSS):
            ...
            for c in range(WhackAMole.NUM_MOLES_ACROSS):
                ...
                mole_label.grid(row=r, column=c, sticky=tk.E + tk.W + tk.S + tk.N)
    ...
    def mole_hit(self, event):
        if self.game_is_running:
            ...
            if hit_label['image'] == self.mole_photo_cover.name:
                #Missed
    ...
    def put_down_mole(self, the_label, timer_expired):
        if self.game_is_running:
            ...
            the_label['image'] = self.mole_photo_cover
